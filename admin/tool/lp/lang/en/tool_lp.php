...
$string['evidencepage'] = 'Add evidence of prior learning';
...
$string['evidencelist'] = 'List of evidence waiting for approval';
$string['evidencename'] = 'Name';
$string['evidencedescription'] = 'Description';
$string['evidencelink'] = 'URL';
$string['evidenceapprove'] = 'Approve';
$string['evidencedecline'] = 'Decline';
$string['evidenceinstitution'] = 'Institution';
$string['evidencedatecompleted'] = 'Date completed';
$string['evidencefileattachments'] = 'Files';
$string['noevidences'] = 'No evidences requests have been submitted yet.';
$string['noevidencetype'] = 'No evidence types have been created';
